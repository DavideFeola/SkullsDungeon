...
public class ExitDoor : MonoBehaviour
{
    ...
    public string nextSceneName = "Stanza2";
    ...
    void Awake()
    {
        ...
        audioSource = GetComponent<AudioSource>(); // ⬅️ NUOVO: Prendi l'AudioSource
    ...
    void CheckEnemies()
    {
        ...
        {
            if (enemy.GetComponent<EnemySniper>() == null)
            {
                regularEnemies++;
            }
        }

        int snipers = FindObjectsByType<EnemySniper>(FindObjectsSortMode.None).Length;
    ...
    void UnlockDoor()
    {
        ...
        // ✅ FERMA LA MUSICA (e pulisce la clip)
    ...
    void OnTriggerEnter2D(Collider2D other)
    {
        ...
        if (isUnlocked)
        {
            ...
            // ✅ Prima di cambiare scena: stop musica e pulizia
            if (AudioManager.Instance != null)
                AudioManager.Instance.StopMusicImmediately(clearClip: true);
